...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.paystack.paystack_sdk.PaystackSDKPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin paystack_flutter_sdk, com.paystack.paystack_sdk.PaystackSDKPlugin", e);
    }
    try {
