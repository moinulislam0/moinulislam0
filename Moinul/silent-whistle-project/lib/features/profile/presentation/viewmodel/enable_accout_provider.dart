...
class EnableAccoutProvider extends ChangeNotifier {
  ...
  Future<bool> enableAccountStatus() async {
    try {
      _isloading = true;
      _errorMessage = null;
      ...
      final response = await _apiService.post(ApiEndPoints.enableAccount);
