...
class LikeCommentProvider extends ChangeNotifier {
  ...
  Future<bool> islikedComment({required String parentId,required String childrenId}) async {
    _isloading = true;
    _isError = null;
    _isSuccess = null;
    notifyListeners();
    ...
    try {
      // API Call
      final response = await _apiService.post(ApiEndPoints.likeComment(parentId, childrenId));
